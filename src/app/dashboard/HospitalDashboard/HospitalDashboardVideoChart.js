...
const HospitalDashboardVideoChart = () => {
  return (
    <>
      <div className={styles.main_div_data_Graph_data}>
        <div className={styles.main_div_for_ravanyou_manage}>
          <Heading className={styles.main_div_tharty_parsant} text={"30%"} />
          <Caption
            text={
              "Patient visits have increased by 30% compared to last month."
            }
          />
        </div>
...
export default HospitalDashboardVideoChart;
